...
public class GherkinStepsUserTablePage extends PageObjectInitializationHW5 {
    ...
    public void user_table_should_contain_following_values(DataTable dataTable) {
        ...
        assertThat(userTable.getNumberInTableValues()).isEqualTo(numbers);
        assertThat(userTable.getUserInTableValues()).isEqualTo(names);
        assertThat(userTable.getDescInTableValues()).isEqualTo(descriptions);
    }
}
